function [status]=bet_and_flirt_3_1(feat_loc,ROI_name,mask_threshold,atlas_threshold)
...
atlas = ['${FSLDIR}//data/atlases/HarvardOxford/HarvardOxford-cort-maxprob-thr',num2str(atlas_threshold),'-2mm.nii.gz'];
