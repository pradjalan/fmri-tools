function fdr_correction_3(p_file,mask_file, out_file_path)
...
p_val_mask=p_values; p_val_mask(:)=0;
[sorted_p_values,sorted_p_indices] = sort(abs(p_values),'ascend');
...
disp(['Saved FDR corrected file: ',out_file_name])
