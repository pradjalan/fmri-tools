function run_cc(input_dir_base,feat_dir_list,ROI_name,mask_threshold,atlas_path,atlas_threshold,output_dir_base,log_path)
...
%         ROI_name = char(ROIs(rn));
        ...
        while ischar(fline)
            ...
            if isempty(strfind(c,'feat'))==0
                ...
                fprintf(logfile,'\nExtracting ROIs..');
                bet_and_flirt_3(feat_loc,ROI_name,mask_threshold,atlas_path,atlas_threshold);
